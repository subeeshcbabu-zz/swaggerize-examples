...
/**
 * Test for /legacy/issues/search/{owner}/{repository}/{state}/{keyword}
 */
Test('/legacy/issues/search/{owner}/{repository}/{state}/{keyword}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/legacy/issues/search/{owner}/{repository}/{state}/{keyword}']['get']['responses']['200']['schema']);
