...
/**
 * Test for /legacy/user/email/{email}
 */
Test('/legacy/user/email/{email}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/legacy/user/email/{email}']['get']['responses']['200']['schema']);
