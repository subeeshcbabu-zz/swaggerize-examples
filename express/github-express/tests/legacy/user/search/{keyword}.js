...
/**
 * Test for /legacy/user/search/{keyword}
 */
Test('/legacy/user/search/{keyword}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/legacy/user/search/{keyword}']['get']['responses']['200']['schema']);
