...
/**
 * Test for /networks/{owner}/{repo}/events
 */
Test('/networks/{owner}/{repo}/events', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/networks/{owner}/{repo}/events']['get']['responses']['200']['schema']);
