...
/**
 * Test for /notifications/threads/{id}
 */
Test('/notifications/threads/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/notifications/threads/{id}']['get']['responses']['200']['schema']);
        ...
        t.test('test  patch operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    t.error(err, 'No error');
                    t.ok(res.statusCode === 205, 'Ok response status');
                    t.end();
                });
            });
        });
