...
/**
 * Test for /repos/{owner}/{repo}/compare/{baseId}...{headId}
 */
Test('/repos/{owner}/{repo}/compare/{baseId}...{headId}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/compare/{baseId}...{headId}']['get']['responses']['200']['schema']);
