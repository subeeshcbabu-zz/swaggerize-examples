...
/**
 * Test for /repos/{owner}/{repo}/deployments/{id}/statuses
 */
Test('/repos/{owner}/{repo}/deployments/{id}/statuses', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/deployments/{id}/statuses']['get']['responses']['200']['schema']);
