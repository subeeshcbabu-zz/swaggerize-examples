...
/**
 * Test for /repos/{owner}/{repo}/downloads
 */
Test('/repos/{owner}/{repo}/downloads', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/downloads']['get']['responses']['200']['schema']);
