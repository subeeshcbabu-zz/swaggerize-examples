...
/**
 * Test for /repos/{owner}/{repo}/git/blobs
 */
Test('/repos/{owner}/{repo}/git/blobs', function (t) {
        ...
        t.test('test  post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/git/blobs']['post']['responses']['201']['schema']);
