...
/**
 * Test for /repos/{owner}/{repo}/issues/comments
 */
Test('/repos/{owner}/{repo}/issues/comments', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/issues/comments']['get']['responses']['200']['schema']);
