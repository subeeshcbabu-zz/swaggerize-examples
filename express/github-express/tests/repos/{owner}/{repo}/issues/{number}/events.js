...
/**
 * Test for /repos/{owner}/{repo}/issues/{number}/events
 */
Test('/repos/{owner}/{repo}/issues/{number}/events', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/issues/{number}/events']['get']['responses']['200']['schema']);
