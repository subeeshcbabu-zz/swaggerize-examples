...
/**
 * Test for /repos/{owner}/{repo}/languages
 */
Test('/repos/{owner}/{repo}/languages', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/languages']['get']['responses']['200']['schema']);
