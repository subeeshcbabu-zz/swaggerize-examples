...
/**
 * Test for /repos/{owner}/{repo}/merges
 */
Test('/repos/{owner}/{repo}/merges', function (t) {
        ...
        t.test('test  post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/merges']['post']['responses']['201']['schema']);
