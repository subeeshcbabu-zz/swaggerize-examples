...
/**
 * Test for /repos/{owner}/{repo}/milestones/{number}/labels
 */
Test('/repos/{owner}/{repo}/milestones/{number}/labels', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/milestones/{number}/labels']['get']['responses']['200']['schema']);
