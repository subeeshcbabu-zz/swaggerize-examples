...
/**
 * Test for /repos/{owner}/{repo}/pulls/{number}/merge
 */
Test('/repos/{owner}/{repo}/pulls/{number}/merge', function (t) {
        ...
        t.test('test  put operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/pulls/{number}/merge']['put']['responses']['200']['schema']);
