...
/**
 * Test for /repos/{owner}/{repo}/readme
 */
Test('/repos/{owner}/{repo}/readme', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/readme']['get']['responses']['200']['schema']);
