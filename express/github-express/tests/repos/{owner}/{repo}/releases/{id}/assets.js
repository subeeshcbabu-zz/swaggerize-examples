...
/**
 * Test for /repos/{owner}/{repo}/releases/{id}/assets
 */
Test('/repos/{owner}/{repo}/releases/{id}/assets', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/releases/{id}/assets']['get']['responses']['200']['schema']);
