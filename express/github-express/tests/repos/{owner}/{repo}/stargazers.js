...
/**
 * Test for /repos/{owner}/{repo}/stargazers
 */
Test('/repos/{owner}/{repo}/stargazers', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/stargazers']['get']['responses']['200']['schema']);
