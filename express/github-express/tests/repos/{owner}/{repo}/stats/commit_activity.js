...
/**
 * Test for /repos/{owner}/{repo}/stats/commit_activity
 */
Test('/repos/{owner}/{repo}/stats/commit_activity', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/stats/commit_activity']['get']['responses']['200']['schema']);
