...
/**
 * Test for /users/{username}/followers
 */
Test('/users/{username}/followers', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/users/{username}/followers']['get']['responses']['200']['schema']);
