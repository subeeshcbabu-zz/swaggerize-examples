...
/**
 * Test for /api/iris/akin-poem-snippets
 */
Test('/api/iris/akin-poem-snippets', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getAkinPoemSnippets post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/iris/akin-poem-snippets']['post']['responses']['200']['schema']);
