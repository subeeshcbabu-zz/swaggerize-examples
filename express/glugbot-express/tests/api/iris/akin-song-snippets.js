...
/**
 * Test for /api/iris/akin-song-snippets
 */
Test('/api/iris/akin-song-snippets', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getAkinSongSnippets post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/iris/akin-song-snippets']['post']['responses']['200']['schema']);
