...
/**
 * Test for /management/accounts/{accountId}/webproperties
 */
Test('/management/accounts/{accountId}/webproperties', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test analytics.management.webproperties.list get operation', function (t) {
            Mockgen().requests({
