...
/**
 * Test for /management/accounts/{accountId}/webproperties/{webPropertyId}/profiles
 */
Test('/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test analytics.management.profiles.list get operation', function (t) {
            Mockgen().requests({
