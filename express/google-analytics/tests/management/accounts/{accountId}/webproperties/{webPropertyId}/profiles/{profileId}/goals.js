...
/**
 * Test for /management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/goals
 */
Test('/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/goals', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test analytics.management.goals.list get operation', function (t) {
            Mockgen().requests({
                ...
                request = Request(App)
                    .get('/analytics/v2.4' + mock.request.path);
