...
/**
 * Test for /gitignore/templates/{language}
 */
Test('/gitignore/templates/{language}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * parameters: language, X-GitHub-Media-Type, Accept, X-RateLimit-Limit, X-RateLimit-Remaining, X-RateLimit-Reset, X-GitHub-Request-Id
         * produces: 
         * responses: 200, 403
         */
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/gitignore/templates/{language}']['get']['responses']['200']['schema']);
