...
/**
 * Test for /legacy/repos/search/{keyword}
 */
Test('/legacy/repos/search/{keyword}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/legacy/repos/search/{keyword}']['get']['responses']['200']['schema']);
