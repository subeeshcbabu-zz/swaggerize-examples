...
/**
 * Test for /orgs/{org}/repos
 */
Test('/orgs/{org}/repos', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/orgs/{org}/repos']['get']['responses']['200']['schema']);
        ...
        t.test('test  post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var Validator = require('is-my-json-valid');
                    var validate = Validator(api.paths['/orgs/{org}/repos']['post']['responses']['201']['schema']);
                    var response = res.body;
                    if (Object.keys(response).length <= 0) {
                        response = res.text;
                    }
