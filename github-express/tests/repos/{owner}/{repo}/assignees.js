...
/**
 * Test for /repos/{owner}/{repo}/assignees
 */
Test('/repos/{owner}/{repo}/assignees', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/assignees']['get']['responses']['200']['schema']);
