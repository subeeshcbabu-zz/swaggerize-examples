...
/**
 * Test for /repos/{owner}/{repo}/branches
 */
Test('/repos/{owner}/{repo}/branches', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/branches']['get']['responses']['200']['schema']);
