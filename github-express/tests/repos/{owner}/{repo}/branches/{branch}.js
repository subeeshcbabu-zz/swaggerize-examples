...
/**
 * Test for /repos/{owner}/{repo}/branches/{branch}
 */
Test('/repos/{owner}/{repo}/branches/{branch}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/branches/{branch}']['get']['responses']['200']['schema']);
