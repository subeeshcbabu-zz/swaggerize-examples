...
/**
 * Test for /repos/{owner}/{repo}/commits
 */
Test('/repos/{owner}/{repo}/commits', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/commits']['get']['responses']['200']['schema']);
