...
/**
 * Test for /repos/{owner}/{repo}/commits/{ref}/status
 */
Test('/repos/{owner}/{repo}/commits/{ref}/status', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/commits/{ref}/status']['get']['responses']['200']['schema']);
