...
/**
 * Test for /repos/{owner}/{repo}/commits/{shaCode}
 */
Test('/repos/{owner}/{repo}/commits/{shaCode}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/commits/{shaCode}']['get']['responses']['200']['schema']);
