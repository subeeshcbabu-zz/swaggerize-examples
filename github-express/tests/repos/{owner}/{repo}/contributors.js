...
/**
 * Test for /repos/{owner}/{repo}/contributors
 */
Test('/repos/{owner}/{repo}/contributors', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/contributors']['get']['responses']['200']['schema']);
