...
/**
 * Test for /repos/{owner}/{repo}/downloads/{downloadId}
 */
Test('/repos/{owner}/{repo}/downloads/{downloadId}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/downloads/{downloadId}']['get']['responses']['200']['schema']);
