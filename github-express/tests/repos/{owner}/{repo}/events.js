...
/**
 * Test for /repos/{owner}/{repo}/events
 */
Test('/repos/{owner}/{repo}/events', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/events']['get']['responses']['200']['schema']);
