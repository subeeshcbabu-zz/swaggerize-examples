...
/**
 * Test for /repos/{owner}/{repo}/git/blobs/{shaCode}
 */
Test('/repos/{owner}/{repo}/git/blobs/{shaCode}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/git/blobs/{shaCode}']['get']['responses']['200']['schema']);
