...
/**
 * Test for /repos/{owner}/{repo}/git/tags/{shaCode}
 */
Test('/repos/{owner}/{repo}/git/tags/{shaCode}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/git/tags/{shaCode}']['get']['responses']['200']['schema']);
