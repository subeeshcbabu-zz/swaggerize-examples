...
/**
 * Test for /repos/{owner}/{repo}/git/trees
 */
Test('/repos/{owner}/{repo}/git/trees', function (t) {
        ...
        t.test('test  post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/git/trees']['post']['responses']['201']['schema']);
