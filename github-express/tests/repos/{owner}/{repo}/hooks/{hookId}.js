...
/**
 * Test for /repos/{owner}/{repo}/hooks/{hookId}
 */
Test('/repos/{owner}/{repo}/hooks/{hookId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/hooks/{hookId}']['get']['responses']['200']['schema']);
         ...
         * parameters: owner, repo, hookId, X-GitHub-Media-Type, Accept, X-RateLimit-Limit, X-RateLimit-Remaining, X-RateLimit-Reset, X-GitHub-Request-Id, body
         * produces: 
         * responses: 200, 403
         */
        t.test('test  patch operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    t.ok(res.statusCode === 200, 'Ok response status');
                    var Validator = require('is-my-json-valid');
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/hooks/{hookId}']['patch']['responses']['200']['schema']);
                    var response = res.body;
                    if (Object.keys(response).length <= 0) {
                        response = res.text;
                    }
