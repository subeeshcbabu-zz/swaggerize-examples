...
/**
 * Test for /repos/{owner}/{repo}/issues/events
 */
Test('/repos/{owner}/{repo}/issues/events', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/issues/events']['get']['responses']['200']['schema']);
