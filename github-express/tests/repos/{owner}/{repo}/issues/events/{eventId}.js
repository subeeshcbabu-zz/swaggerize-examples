...
/**
 * Test for /repos/{owner}/{repo}/issues/events/{eventId}
 */
Test('/repos/{owner}/{repo}/issues/events/{eventId}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/issues/events/{eventId}']['get']['responses']['200']['schema']);
