...
/**
 * Test for /repos/{owner}/{repo}/keys/{keyId}
 */
Test('/repos/{owner}/{repo}/keys/{keyId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * parameters: owner, repo, keyId, X-GitHub-Media-Type, Accept, X-RateLimit-Limit, X-RateLimit-Remaining, X-RateLimit-Reset, X-GitHub-Request-Id
         * produces: 
         * responses: 204, 403
         */
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/keys/{keyId}']['get']['responses']['200']['schema']);
