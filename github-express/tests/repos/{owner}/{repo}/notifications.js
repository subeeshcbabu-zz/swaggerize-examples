...
/**
 * Test for /repos/{owner}/{repo}/notifications
 */
Test('/repos/{owner}/{repo}/notifications', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/notifications']['get']['responses']['200']['schema']);
