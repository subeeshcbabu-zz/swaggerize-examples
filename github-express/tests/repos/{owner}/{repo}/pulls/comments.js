...
/**
 * Test for /repos/{owner}/{repo}/pulls/comments
 */
Test('/repos/{owner}/{repo}/pulls/comments', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/pulls/comments']['get']['responses']['200']['schema']);
