...
/**
 * Test for /repos/{owner}/{repo}/pulls/{number}/commits
 */
Test('/repos/{owner}/{repo}/pulls/{number}/commits', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/pulls/{number}/commits']['get']['responses']['200']['schema']);
