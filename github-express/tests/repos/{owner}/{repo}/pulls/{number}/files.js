...
/**
 * Test for /repos/{owner}/{repo}/pulls/{number}/files
 */
Test('/repos/{owner}/{repo}/pulls/{number}/files', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/pulls/{number}/files']['get']['responses']['200']['schema']);
