...
/**
 * Test for /repos/{owner}/{repo}/stats/participation
 */
Test('/repos/{owner}/{repo}/stats/participation', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/stats/participation']['get']['responses']['200']['schema']);
