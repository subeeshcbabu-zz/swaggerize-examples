...
/**
 * Test for /repos/{owner}/{repo}/subscribers
 */
Test('/repos/{owner}/{repo}/subscribers', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/subscribers']['get']['responses']['200']['schema']);
