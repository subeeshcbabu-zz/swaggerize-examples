...
/**
 * Test for /repos/{owner}/{repo}/watchers
 */
Test('/repos/{owner}/{repo}/watchers', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/repos/{owner}/{repo}/watchers']['get']['responses']['200']['schema']);
