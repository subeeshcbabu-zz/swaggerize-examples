...
/**
 * Test for /users/{username}/gists
 */
Test('/users/{username}/gists', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * parameters: username, since, X-GitHub-Media-Type, Accept, X-RateLimit-Limit, X-RateLimit-Remaining, X-RateLimit-Reset, X-GitHub-Request-Id
         * produces: 
         * responses: 200, 403
         */
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/users/{username}/gists']['get']['responses']['200']['schema']);
