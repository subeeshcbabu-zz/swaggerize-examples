...
/**
 * Test for /api/iris/akin-quotes
 */
Test('/api/iris/akin-quotes', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getAkinQuotes post operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/iris/akin-quotes']['post']['responses']['200']['schema']);
