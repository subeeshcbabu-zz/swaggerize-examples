...
/**
 * Test for /api/random/quote
 */
Test('/api/random/quote', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getRandomQuote get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/api/random/quote']['get']['responses']['200']['schema']);
