...
/**
 * Test for /v1.0/getForecastPoints/{yatchclubid}/language/{language}
 */
Test('/v1.0/getForecastPoints/{yatchclubid}/language/{language}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getForecastPoints get operation', function (t) {
            Mockgen().requests({
