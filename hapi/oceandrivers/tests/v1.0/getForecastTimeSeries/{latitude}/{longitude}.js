...
/**
 * Test for /v1.0/getForecastTimeSeries/{latitude}/{longitude}/
 */
Test('/v1.0/getForecastTimeSeries/{latitude}/{longitude}/', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getForecastTimeSeries get operation', function (t) {
            Mockgen().requests({
