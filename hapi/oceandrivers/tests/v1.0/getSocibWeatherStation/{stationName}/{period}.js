...
/**
 * Test for /v1.0/getSocibWeatherStation/{stationName}/{period}/
 */
Test('/v1.0/getSocibWeatherStation/{stationName}/{period}/', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test getSocibWeatherStation get operation', function (t) {
            Mockgen().requests({
