...
/**
 * Test for /browse/categories/{category_id}
 */
Test('/browse/categories/{category_id}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                server.inject(options, function (res) {
                    ...
                    var validate = Validator(api.paths['/browse/categories/{category_id}']['get']['responses']['200']['schema']);
