...
/**
 * Test for /browse/categories/{category_id}/playlists
 */
Test('/browse/categories/{category_id}/playlists', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                server.inject(options, function (res) {
                    ...
                    var validate = Validator(api.paths['/browse/categories/{category_id}/playlists']['get']['responses']['200']['schema']);
