...
/**
 * Test for /browse/featured-playlists
 */
Test('/browse/featured-playlists', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                server.inject(options, function (res) {
                    ...
                    var validate = Validator(api.paths['/browse/featured-playlists']['get']['responses']['200']['schema']);
