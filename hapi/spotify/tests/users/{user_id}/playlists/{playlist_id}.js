...
/**
 * Test for /users/{user_id}/playlists/{playlist_id}
 */
Test('/users/{user_id}/playlists/{playlist_id}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                server.inject(options, function (res) {
                    ...
                    var validate = Validator(api.paths['/users/{user_id}/playlists/{playlist_id}']['get']['responses']['200']['schema']);
