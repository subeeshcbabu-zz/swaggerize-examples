...
/**
 * Test for /users/{user_id}/playlists/{playlist_id}/followers/contains
 */
Test('/users/{user_id}/playlists/{playlist_id}/followers/contains', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                server.inject(options, function (res) {
                    ...
                    var validate = Validator(api.paths['/users/{user_id}/playlists/{playlist_id}/followers/contains']['get']['responses']['200']['schema']);
