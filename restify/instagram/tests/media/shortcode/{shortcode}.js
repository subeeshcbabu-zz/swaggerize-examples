...
/**
 * Test for /media/shortcode/{shortcode}
 */
Test('/media/shortcode/{shortcode}', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/media/shortcode/{shortcode}']['get']['responses']['200']['schema']);
