...
/**
 * Test for /media/{media-id}/comments/{comment-id}
 */
Test('/media/{media-id}/comments/{comment-id}', function (t) {
        ...
        t.test('test  delete operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/media/{media-id}/comments/{comment-id}']['delete']['responses']['200']['schema']);
