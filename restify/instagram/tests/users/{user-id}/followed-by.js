...
/**
 * Test for /users/{user-id}/followed-by
 */
Test('/users/{user-id}/followed-by', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/users/{user-id}/followed-by']['get']['responses']['200']['schema']);
