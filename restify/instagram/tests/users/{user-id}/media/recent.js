...
/**
 * Test for /users/{user-id}/media/recent
 */
Test('/users/{user-id}/media/recent', function (t) {
        ...
        t.test('test  get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/users/{user-id}/media/recent']['get']['responses']['200']['schema']);
